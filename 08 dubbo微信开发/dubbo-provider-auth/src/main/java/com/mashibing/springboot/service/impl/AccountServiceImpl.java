package com.mashibing.springboot.service.impl;
...
//		List<Account> list = accMapper.selectByExample(example );
	...
	public void insertAccount(Account account) {
		...
		System.out.println("写入用户");
	}

	@Override
	public Account findByOpendid(String openid) {
		// TODO Auto-generated method stub
		if(RandomUtils.nextBoolean()) {
			System.out.println("有用户");
			Account account = new Account();
			account.setAge(18);
			account.setHeadimgurl("mgurl");
			account.setNickName("hehe");
			account.setOpendid("12345");
			return account;
		}else {
			System.out.println("没有有用户");
			return null;
		}
	}
}
