...
import com.msb.db1.entity.Config;
...
//			StorePath uploadFile = fc.uploadImageAndCrtThumbImage(filename.getInputStream(),filename.getSize(),FilenameUtils.getExtension(filename.getOriginalFilename()), null);
...
//	
//		
//		byte[] bs = fc.downloadFile("group1", "M00/00/00/wKiWC10xyEeAT3E1AAGEk1cjetg328.png", cb);
//		
